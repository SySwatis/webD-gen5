...
<body class="fixed-sidebar">
    ...
    <div class="footer">
        <div class="text-copyright text-right">
            <small><a href="_#" class="">Mentions légales</a> | <span><img src="img/logo-g5x25.png" width="25px"
        ...
        <div class="modal-dialog modal-lg" role="form">
            ...
            <div class="ibox">
                ...
                <!-- <div class="ibox-content">
                    ...
                    <div class="form-container p-3">
                        <form id="mail" name="mail">
                            <p class="mt-3">Ici les champs utiles à la gestion privée des données</p>
                            <input type="hidden" id="uti_num" name="uti_num" value="958">
    ...
    <script src="js/main.js?r2.1"></script>
